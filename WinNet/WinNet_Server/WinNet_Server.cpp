    ...
    case WM_PAINT:
        {
            ...
            if(_tcscmp(msg,_T(""))) TextOut(hdc, 10, 10 + (20 * msgCnt), msg, (int)_tcslen(msg));
            msgCnt++;
...
int WinSocketTest_Server()
{
    ...
    do
    {
        ...
        SOCKET sc = accept(s, (LPSOCKADDR)&c_addr, &size);

        char buffer[100];
        int msgLen;
        msgLen = recv(sc, buffer, 100, 0);
        buffer[msgLen] = NULL;
